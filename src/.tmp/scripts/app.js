...
var testimonialsCarousel = new _siema2.default({
...
var screenshotsCarousel = new _siema2.default({
...
function makeControlActive(controlSelector, activeClass, currentSlide) {
  var controlsArray = Array.from(document.querySelectorAll(controlSelector));
  var currentActiveSlideControl = controlsArray[currentSlide];
  var activeControl = document.querySelector('.' + activeClass);
  activeControl.classList.remove(activeClass);
  currentActiveSlideControl.classList.add(activeClass);
}

_siema2.default.prototype.addControls = function (controlSelector, activeClass) {
  var _this = this;

  var controlsArray = Array.from(document.querySelectorAll(controlSelector));
  var currentSlideControl = controlsArray[this.currentSlide];
...
_siema2.default.prototype.addAutoplay = function () {
  var _this2 = this;
...
var Navigation = function () {
  ...
  _createClass(Navigation, [{
    key: 'isNavListCollapsed',
    value: function isNavListCollapsed() {
    ...
    key: 'addBackgroundOnScroll',
    value: function addBackgroundOnScroll() {
